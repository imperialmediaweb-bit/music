...
GENRE_PROFILES: dict[str, dict] = {
    "afro house": {
        ...
        "thumbnail_core": (
            "An EPIC, CINEMATIC West African inspired ceremonial portrait — designed to STOP THE "
            "SCROLL and force a click. Either: (A) a dramatic close-up of a carved ceremonial "
            "wooden mask (Yoruba, Dogon, Fang, Punu, Dan, Kuba, Chokwe, Makonde, Baule, Songye, "
            "Luba, or Bamana artistic style) with sparks, embers, golden dust particles, or "
            "swirling smoke around it, OR (B) a stunning photorealistic African heritage portrait "
            "(young powerful warrior, queen, or shaman) with intense expressive eyes, gold body "
            "paint, decorative dot patterns, copper jewelry, ornate woven headdress with feathers "
            "and cowrie shells. STYLE: hyper-realistic cinematic oil painting, ultra-detailed, "
            "ultra-sharp focus on the subject. WARM SATURATED palette: deep gold, glowing amber, "
            "molten copper, bronze, burnt orange, ochre, ruby red, with rim-light highlights "
            "around the face/mask. DRAMATIC lighting: strong directional spotlight from one side, "
            "deep cinematic shadows on the other, golden light rays cutting through dark smoke or "
            "dust. Background: pitch dark with subtle glowing embers or distant fire light — "
            "creates EXTREME contrast so the face POPS against the dark. Face/mask fills 65-75% "
            "of the frame, slightly off-center for dynamic composition. The mood is POWERFUL, "
            "MYSTIC, RITUALISTIC — like a movie poster. NO neon, NO lasers, NO sci-fi, NO modern "
            "elements. Think Black Panther meets museum oil painting. 4K ultra detailed."
        ),
