...
{{
  ...
  "youtube_description": "Write a NATURAL, viewer-first YouTube description (8-12 short lines). YouTube penalizes keyword stuffing — keywords live in the video TAGS, so the description must read like a human wrote it for listeners.\\n\\nSTRUCTURE:\\n1. LINE 1 (shown in search results): an irresistible HOOK naming the track and '{genre}' ONCE — a benefit or curiosity gap, e.g. 'The {genre} mix your speakers were built for.'\\n2. 2-4 short lines describing the vibe and journey of the mix (instruments, energy, atmosphere) in plain engaging language — write for a listener, not a search engine.\\n3. ONE line of use cases, casual: e.g. 'Perfect for late night drives, workouts or deep focus.'\\n4. CTA (1-2 lines): like, subscribe, comment your favorite drop.\\n5. CONTACT: imperialmediaweb@gmail.com\\n\\nRULES:\\n- NO keyword lists, NO repeating '{genre}' more than twice total, NO stuffed search phrases\\n- Do NOT include hashtags (#) — they are appended separately at the end\\n- VARY structure and wording every time — no two descriptions alike\\n- Short lines, breathing room, easy to skim",
