...
GENRE_PROFILES: dict[str, dict] = {
    "afro house": {
        ...
        "thumbnail_core": (
            ...
            "Kuba, Chokwe, Makonde, Baule, Songye, Luba, or Bamana style). STYLE: oil painting, "
            "hyper-realistic, rich warm tones (deep brown, bronze, gold, amber, ochre, burnt sienna). "
            "Carved wooden mask with real wood grain texture, cowrie shells, bone beads, raffia fiber, "
            "natural feathers, brass and copper ornaments, tribal scarification marks, face paint in "
            "ochre/indigo/kaolin white. OR a photorealistic African face portrait with closed eyes, "
            "tribal markings, ritual dots, and a woven/carved halo or headdress. "
