...
GENRE_PROFILES: dict[str, dict] = {
    "afro house": {
        ...
        "thumbnail_core": (
            "An authentic West African inspired ceremonial wooden mask or portrait "
            "(Yoruba, Dogon, Fang, Punu, Dan, Kuba, Chokwe, Makonde, Baule, Songye, "
            "Luba, or Bamana artistic style). STYLE: oil painting, hyper-realistic, "
            "rich warm tones (deep brown, bronze, gold, amber, ochre, burnt sienna). "
            "Carved wooden ceremonial face with real wood grain texture, cowrie shells, "
            "bone beads, raffia fiber, natural feathers, brass and copper ornaments, "
            "decorative carved patterns, face paint in ochre/indigo/kaolin white. "
            "OR a photorealistic African heritage portrait with closed eyes, "
            "decorative dot patterns, and a woven or carved halo / headdress. "
            "Face fills 60-70% of the frame, CENTERED composition. Background: warm dark tones "
            "(deep brown, dark amber, burnt umber) — NOT black. Soft dramatic side lighting like "
            "a Renaissance painting. NO neon, NO lasers, NO glowing eyes, NO sci-fi effects, "
            "NO modern elements. The mood is sacred, ancestral, spiritual, and warm. "
            "Think museum-quality oil painting or fine art photography. 4K ultra detailed."
        ),
